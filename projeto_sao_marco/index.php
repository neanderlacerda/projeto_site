...
<html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- Cabeçalho -->
      <div id="header">
        <img src="imagens/logo2.png" alt="falha ao carregar logo" align="center">
      ...
      <nav class="navbar navbar-expand-lg navbar-light shadow p-3 mb-0" style="background-color: #FF8C00;">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav">
            ...
            <li class="nav-item <?= ($pagina == 'chamados_registrados')?'active':'' ?>">
              <a class="nav-link" href="?pagina=crud_chamado/chamados_registrados">Meus Chamados</a>
            </li>
